...
\usepackage{subcaption} % \subfigure-command
...
\newcommand{\divg}[1]{\text{div}(#1)} % Divergenz
...
\input{Arbeit/Fourier_Charakteristiken}

\input{Arbeit/Klassifikation_Unstetigkeit}
